...
const NavigationCard = () => {
  ...
  const activeElementClasses =
    "text-sm md:text-md flex md:gap-3 py-3 my-1 bg-socialBlue text-white md:-mx-8 px-6 md:px-8 rounded-md shadow-md shadow-gray-300";
  const nonActiveElementClasses =
    "text-sm md:text-md flex md:gap-3 py-2 my-2 hover:bg-blue-500 hover:bg-opacity-20 md:-mx-4 md:px-4 px-6 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300";
